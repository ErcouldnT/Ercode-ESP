...
class Water(DisplayObject):
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        self.water_percentage = self._get_water_percentage(address)
        self.my_coords = my_coords
        self.raw_name = raw_name

        # Generate our Ship's water percentage info
        self.name = waters.get(self.raw_name).get("Name")
    ...
    def _built_text_string(self) -> str:
        ...
        """
        return f"Sunk: {self.water_percentage}%"
